...
void makeQ2c_HAA()
{
  ...
  const Int_t N = 10;
  const Int_t Ng = 2;
  Char_t *FileName[N] = {"../data/PHSD/homework2c_HAA-phsd.txt",
			 "",
			 "",
			 "../data/TAMU/Z_results-data/2c_HAA.txt",
			 "",
			 "",
			 "",
			 "",
  ...
  h0->GetYaxis()->SetTitle("H_{AA} = R_{AA}^{FO}/R_{AA}^{H}");
  ...
  c1->Update();
  c1->SaveAs("../fig/Q2c_HAA.pdf");
  c1->SaveAs("../fig/Q2c_HAA.png"); 
