...
void makeQ1c_B(const float T_in = 0.3)
{
  gROOT->Reset();
  ...
  Char_t *FileName[N] = {"../data/PHSD/charm/homework1c-charm-phsd.dat",
			 "../data/CUJET/LGR/LGR_Q1/Q1_c_Kappa.dat",
			 "../data/Duke/kappaT.dat",
			 "../data/TAMU/Z_results-data/1c_A_B.txt",
  			 "../data/Catania/Table_Transport_Coefficients.dat",
			 "../data/LBT/LBT/data-1c-LBT-c-momentum-diffusion.dat"};
  ...
  if(iT==2) {  // Nantes T = 0.2 GeV
    gr_add[0] = new TGraph("../data/Nantes/task1/BT_el_ra_0.2.txt","%lg %lg");
    gr_add[1] = new TGraph("../data/Nantes/task1/BT_el_0.2.txt","%lg %lg");
  }
  if(iT==7) {  // Nantes T = 0.3 GeV
    gr_add[0] = new TGraph("../data/Nantes/task1/BT_el_ra_0.3.txt","%lg %lg");
    gr_add[1] = new TGraph("../data/Nantes/task1/BT_el_0.3.txt","%lg %lg");
  }
  if(iT==12) {  // Nantes T = 0.4 GeV
    gr_add[0] = new TGraph("../data/Nantes/task1/BT_el_ra_0.4.txt","%lg %lg");
    gr_add[1] = new TGraph("../data/Nantes/task1/BT_el_0.4.txt","%lg %lg");
  }
  ...
  c1->Update();
  c1->SaveAs(Form("../fig/Q1c_B_%4.2f.pdf",T_in));
  c1->SaveAs(Form("../fig/Q1c_B_%4.2f.png",T_in));
