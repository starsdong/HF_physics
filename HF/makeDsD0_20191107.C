...
void makeDsD0_20191107(const Int_t mPlotTh = 0)
{
  gROOT->Reset();

  const Int_t NConfig = 5;
  const Int_t NMax = 8;
  const Int_t N[NConfig] = {4, 4, 4, 8, 4}; // ALICE_pp, ALICE_PbPb, STAR_AuAu
  ...
  int n = 0;
  TFile *fin = new TFile("/Users/starsdong/work/Paper/MINE/HFT_Ds/macros/root/ALICE_pp7TeV_PbPb5TeV_Pythia.root");
  ...
  */  
  ...
  c1->SaveAs("fig/DsD0Ratio_20191107.pdf");
  c1->SaveAs("fig/DsD0Ratio_20191107.png");
