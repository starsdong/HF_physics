...
void makeQ1c_A_bottom(const float T_in = 0.3)
{
  gROOT->Reset();
  ...
  TLegend *leg = new TLegend(0.58, 0.88-Ng*0.06, 0.86, 0.94);
  leg->SetFillColor(10);
  //   leg->SetFillStyle(10);
  ...
  c1->Update();
  c1->SaveAs(Form("../fig/Q1c_A_bottom_%4.2f.pdf",T_in));
  c1->SaveAs(Form("../fig/Q1c_A_bottom_%4.2f.png",T_in));
