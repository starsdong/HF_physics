...
void makeQ3a_RAA()
{
  ...
  Char_t *FileName[N] = {"../data/PHSD/homework3a_RAA-phsd.txt",
			 "../data/CUJET/LGR/LGR_Q3/Q3a_RAA.dat",
			 "../data/Duke/HQRAA_3a.dat",
			 "../data/TAMU/Z_results-data/3a_RAA.txt",
			 "",
			 "../data/LBT/LBT/data-3a-RAA-LBT-charm.dat",
			 "../data/Nantes/task3/RAA_c_quark_Nantes_resc_2piDeq4.txt",
			 "../data/Nantes/task3/RAA_c_quark_Nantes_resc_2piDeq4_coll.txt",
			 "../data/DAB-MOD/RAA_Charm_Trento_D2piT_4_Centrality_30_50.dat",
			 "../data/LANL/R-PbPb_c_5TeVG1.8M1.3.0.5rad"};
  ...
  c1->Update();
  c1->SaveAs("../fig/Q3a_RAA.pdf");
  c1->SaveAs("../fig/Q3a_RAA.png"); 
