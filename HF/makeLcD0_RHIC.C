...
void makeLcD0_RHIC()
{
  ...
  */
  ...
  inData.open("dat/LcD0_Rapp_1905.09216.txt");
  for(int i=0;i<N_R;i++) {
  ...
  gr_Rapp->SetFillColor(3);
  gr_Rapp->SetLineColor(3);
  ...
  */
  ...
  TLegend *leg = new TLegend(0.22, 0.84, 0.54, 0.94);
   leg->SetFillColor(10);
   leg->SetFillStyle(10);
   ...
   TLegend *leg = new TLegend(0.7, 0.56, 0.94, 0.94);
   leg->SetFillColor(10);
   leg->SetFillStyle(10);
   leg->SetLineStyle(4000);
   leg->SetLineColor(10);
   ...
   leg->AddEntry(gr_Rapp,"Rapp: 0-20%","f");
   leg->AddEntry(gr_Ko_2019,"Ko 2019: 0-10%","l");
  ...
  c1->SaveAs("fig/LcD0Ratio_RHIC.pdf");
  c1->SaveAs("fig/LcD0Ratio_RHIC.png");
