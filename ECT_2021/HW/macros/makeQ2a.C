...
void makeQ2a()
{
  ...
  const Int_t N = 10;
  const Int_t Ng = 9;
  Char_t *FileName[N] = {"../data/PHSD/homework2a-phsd.txt",
			 "../data/CUJET/LGR/LGR_Q2/Q2_a.dat",
			 "../data/Duke/HAA_2a.dat",
			 "../data/TAMU/Z_results-data/2a_HAA_D0.txt",
			 "../data/Catania/D_ratio.dat",
			 "../data/LBT/LBT/data-2a-HAA-LBT-D-c.dat",
			 "../data/Nantes/task2/HAA_Nantes.txt",
			 "",
			 "../data/DAB-MOD/H_RAA_D0overCharm_Centrality_30_50.dat",
			 "../data/LANL/R-DtoC-PbPb_c_5TeVG1.8M1.3.0.5rad"};
  ...
  c1->Update();
  c1->SaveAs("../fig/Q2a_HAA.pdf");
  c1->SaveAs("../fig/Q2a_HAA.png"); 
