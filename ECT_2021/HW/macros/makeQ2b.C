...
void makeQ2b()
{
  ...
  const Int_t N = 10;
  const Int_t Ng = 9;
  Char_t *FileName[N] = {"../data/PHSD/homework2b-phsd.txt",
			 "../data/CUJET/LGR/LGR_Q2/Q2_b.dat",
			 "../data/Duke/Hv2_2b.dat",
			 "../data/TAMU/Z_results-data/2b_Hv2_D0.txt",
			 "../data/Catania/v2_ratio.dat",
			 "../data/LBT/LBT/data-2b-Hv2-LBT-D-c.dat",
			 "../data/Nantes/task2/Hv2_Nantes.txt",
			 "",
			 "../data/DAB-MOD/H_v2_D0overCharm_Centrality_30_50.dat",
			 "../data/LANL/v2-DtoC-PbPb_c_5TeVG1.8M1.3N"};
  ...
  h0->GetYaxis()->SetTitle("H_{v2} = v_{2}^{H}/v_{2}^{Q}");
  ...
  c1->Update();
  c1->SaveAs("../fig/Q2b_Hv2.pdf");
  c1->SaveAs("../fig/Q2b_Hv2.png"); 
