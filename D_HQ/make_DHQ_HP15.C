...
void make_DHQ_HP15()
{
  ...
  const Int_t n_txt1 = 7;
  const Double_t x_txt1[n_txt1] = {0.7, 1.6, 1.6, 1.6, 1.65, 1.1, 1.48};
  const Double_t y_txt1[n_txt1] = {16, 32.5, 24, 10., 4.5, 8, 1};
  const Double_t angle_txt1[n_txt1] = {-45, 5, 7, 8, 2, 0, 0};
  //  const Char_t *tex_txt1[n_txt1] = {"HRG", "pQCD LO", "T-Matrix F-pol", "T-Matrix U-pol", "pQCD+HTL", "Lattice: Banerjee", "Lattice: Ding"};
  const Char_t *tex_txt1[n_txt1] = {"HRG", "pQCD LO", "T-Matrix F-pol", "T-Matrix U-pol", "MC@sHQ", "Lattice: Banerjee", "Lattice: Ding"};
  ...
  */
  ...
  c1->Update();
  c1->SaveAs("fig/D_HQ_HP15.eps");
  c1->SaveAs("fig/D_HQ_HP15.png");
}
